...
const KOMPETENSI_TOOLS = [
  ...
  },
  {
    ...
    desc: "Pilih jenis pengadaan, sumber dana (APBN/APBD/BUMN), dan nilai pagu → AI generate panduan PBJ: metode + alasan, tahapan + dokumen per fase + PIC, syarat kualifikasi penyedia, metode evaluasi, kesalahan umum + pencegahan. Sesuai Perpres 12/2021 & Perlem LKPP.",
    tag: "Kompetensi",
    model: "GPT-4o-mini",
  },
  {
