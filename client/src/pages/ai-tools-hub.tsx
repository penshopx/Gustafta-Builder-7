...
const KOMPETENSI_TOOLS = [
  ...
  },
  {
    ...
    desc: "Pilih jenis pengadaan, metode kualifikasi, klasifikasi SBU, dan pengalaman → AI analisis gap persyaratan kualifikasi berdasarkan Perpres 12/2021: skor kesiapan, status per persyaratan, checklist dokumen, dan strategi pemenangan tender.",
    tag: "Kompetensi",
    model: "GPT-4o-mini",
  },
  {
