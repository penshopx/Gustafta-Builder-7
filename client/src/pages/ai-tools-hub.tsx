...
const KOMPETENSI_TOOLS = [
  ...
  },
  {
    ...
    desc: "Input indeks harga konstruksi BPS awal vs akhir per material + volume → hitung eskalasi bruto & klaim bersih berdasarkan klausul persentase (Perpres 28/2025). Real-time tanpa AI — preset 10 material konstruksi, dapat ditambah sendiri.",
    tag: "Kompetensi",
  ...
  },
  {
    ...
    desc: "Pilih jenis pengadaan, metode kualifikasi, klasifikasi SBU, dan pengalaman → AI analisis gap persyaratan kualifikasi berdasarkan Perpres 28/2025: skor kesiapan, status per persyaratan, checklist dokumen, dan strategi pemenangan tender.",
    tag: "Kompetensi",
    model: "GPT-4o-mini",
  },
  {
  ...
  },
  {
    ...
    desc: "Pilih jenis pengadaan, sumber dana (APBN/APBD/BUMN), dan nilai pagu → AI generate panduan PBJ: metode + alasan, tahapan + dokumen per fase + PIC, syarat kualifikasi penyedia, metode evaluasi, kesalahan umum + pencegahan. Sesuai Perpres 28/2025 & Perlem LKPP.",
    tag: "Kompetensi",
    model: "GPT-4o-mini",
  },
  {
  ...
  },
  {
    ...
    desc: "Pilih jabatan pengadaan + nilai kontrak → AI jelaskan SKK wajib berdasarkan UU 2/2017, PP 14/2021, Perpres 28/2025 dan regulasi LKPP, konsekuensi tanpa kompetensi, langkah persiapan, dan tips kepatuhan unit kerja pengadaan.",
    tag: "Kompetensi",
    model: "GPT-4o-mini",
  },
  {
