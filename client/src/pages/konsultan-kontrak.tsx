...
const SUB_AGENTS = [
  { role: "CONTRACT-REVIEWER", color: "red", desc: "Analisis klausul kontrak FIDIC, Perpres 28/2025, & kontrak komersial — identifikasi risiko tersembunyi sebelum penandatanganan" },
