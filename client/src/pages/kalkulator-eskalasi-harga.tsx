    ...
    <div className="min-h-screen bg-slate-950 py-6 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="rounded-xl border border-orange-500/20 bg-orange-500/5 px-4 py-3 mb-4 flex items-start gap-2">
          ...
          <p className="text-xs text-orange-300">Masukkan Indeks Harga Konstruksi (IHK/IHBK) dari BPS pada periode kontrak ditandatangani vs periode pelaksanaan. Klausul eskalasi mengacu pada Perpres 12/2021.</p>
        </div>
        ...
        {totalEskalasiNetKlaim > 0 && (
          <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 mb-4">
            ...
            <p className="text-sm text-white">Ajukan addendum CCO sebesar <span className="text-emerald-400 font-bold">{fmt(totalEskalasiNetKlaim)}</span> berdasarkan klausul eskalasi {klausulEskalasi}% sesuai Perpres 12/2021 Pasal 57–58.</p>
          </div>
        )}
