...
import {
  ...
  BarChart3, Shield, Globe, Star, Zap, TrendingUp, FileText,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-white dark:bg-background" data-testid="page-transisi-energi">
      ...
      <section className="py-16 px-4 bg-emerald-50 dark:bg-emerald-900/10">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-white mb-10">Dari Para Pelaku Transisi Energi</h2>
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { name: "Dewi Anggraini, ST", role: "Sustainability Manager, BUMN Energi", text: "ESGClaw sangat membantu penyusunan laporan keberlanjutan kami. Dari GRI disclosure hingga kalkulasi emisi Scope 1-3, semuanya terstruktur." },
              { name: "Hendra K.", role: "Developer PLTS Rooftop", text: "EBTSolarClaw membantu kami memahami persyaratan perizinan PLTS yang berubah-ubah. Sangat membantu saat mengurus SLO dan IUPTL." },
              { name: "Dr. Nining S.", role: "Konsultan AMDAL Lingkungan", text: "LingkunganClaw menjadi referensi cepat saya untuk cek persyaratan dokumen lingkungan per jenis usaha. Menghemat waktu riset regulasi secara signifikan." },
            ].map((t, i) => (
