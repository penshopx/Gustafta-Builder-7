...
import {
  ...
  BookOpen, Users, Star, Lightbulb, Target, Award,
...
export default function AcademicCounselorPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-background" data-testid="page-academic-counselor">
      ...
      <section className="py-16 px-4 bg-white dark:bg-background">
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-bold text-teal-600 uppercase tracking-widest text-center mb-2">Cerita Pengguna</p>
          <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-white mb-10">Dari Siswa, Mahasiswa & Pendidik</h2>
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { name: "Kevin A.", role: "Siswa SMA kelas 12", text: "EducounselClaw membantu saya memilih antara Teknik Sipil dan Arsitektur. AI menganalisis minat, nilai, dan prospek karir — saya jadi yakin dengan pilihan saya." },
              { name: "Putri R.", role: "Mahasiswi S1 Teknik Informatika", text: "IBTUClaw sangat membantu persiapan IELTS saya untuk daftar beasiswa LPDP. Latihan soal per skill-nya sangat terstruktur dan feedback-nya actionable." },
              { name: "Bu Sari, M.Psi", role: "Konselor BK SMAN, Jakarta", text: "EducounselClaw diintegrasikan ke chatbot sekolah kami. Siswa bisa tanya panduan jurusan kapan saja — beban konsultasi manual di jam kerja berkurang signifikan." },
            ].map((t, i) => (
              <div key={i} className="bg-teal-50 dark:bg-teal-900/10 rounded-2xl p-5 border border-teal-100 dark:border-border">
