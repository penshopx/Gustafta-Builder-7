        ...
        {!result && (
          <div className="space-y-4">
            <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/5 px-4 py-3 flex items-start gap-2">
              ...
              <p className="text-xs text-indigo-300">AI akan menganalisis persyaratan kualifikasi berdasarkan Perpres 12/2021, Permen PUPR, dan regulasi pengadaan yang relevan, lalu memberikan gap assessment dan strategi dokumen.</p>
            </div>
