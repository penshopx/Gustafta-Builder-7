...
const TOOLS = [
  ...
  },
  {
    ...
    desc: "Input indeks harga konstruksi BPS awal vs akhir per material + volume → hitung eskalasi bruto dan klaim bersih berdasarkan klausul persentase (Perpres 28/2025). Update real-time, tanpa AI.",
    color: "text-orange-400",
    borderColor: "border-orange-500/30",
    bg: "bg-orange-500/5",
    badge: "Gelombang 11",
  ...
  },
  {
    ...
    sublabel: "Metode PBJ, tahapan, dokumen wajib, evaluasi — Perpres 28/2025 & Perlem LKPP",
  ...
  },
  {
    ...
    desc: "Pilih jenis pengadaan, metode kualifikasi, klasifikasi SBU, subkualifikasi, dan pengalaman → AI analisis gap persyaratan kualifikasi, skor kesiapan 0-100, checklist dokumen yang perlu disiapkan, dan strategi pemenangan tender berdasarkan Perpres 28/2025.",
    color: "text-indigo-400",
    borderColor: "border-indigo-500/30",
    bg: "bg-indigo-500/5",
    badge: "Gelombang 13",
