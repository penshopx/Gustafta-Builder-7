            ...
            {[
              {
                ...
                items: ["Trilogi Ebook (3 ebook panduan)", "Trilogi Prompt Pack", "Panduan Onboarding step-by-step", "Akses Grup WhatsApp komunitas", "Akses Builder 7 hari"],
              ...
              {
                emoji: "💡", num: "04", label: "MENGHASILKAN",
                color: "border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/20",
                badge: "bg-amber-600",
                title: "AI adalah Aset — Bukan Sekadar Alat",
                desc: "Ubah pengetahuan Anda menjadi layanan baru, chatbot premium, produk digital, solusi konsultasi, sistem pendamping kerja, hingga peluang bisnis baru. Jual chatbot Anda melalui Creator Marketplace GUSTAFTA.",
                items: ["Jual chatbot di Creator Marketplace", "Revenue sharing 80/20 untuk creator", "Bangun bisnis berbasis AI", "Penghasilan dari kompetensi yang Anda miliki"],
                cta: "Jadi Creator", href: "/store",
              },
              {
                emoji: "🚀", num: "05", label: "BERKEMBANG",
                color: "border-rose-200 dark:border-rose-800 bg-rose-50 dark:bg-rose-950/20",
                badge: "bg-rose-600",
                title: "Mulai dari Satu Chatbot. Berkembang Menjadi Ekosistem.",
                desc: "Semakin berkembang pengetahuan Anda, semakin berkembang pula AI yang Anda miliki. Platform Gustafta tumbuh bersama Anda.",
                items: null,
                evolution: ["AI Assistant", "AI Agent", "Multi-Agent", "AI Organization", "AI Business Ecosystem"],
                cta: "Lihat Roadmap Ekosistem", href: builderUrl,
              },
            ].map((stage) => (
