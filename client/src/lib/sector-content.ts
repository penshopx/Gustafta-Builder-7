...
export const sectorContentMap: Record<string, SectorContent> = {
  engineering: {
    ...
    tagline: "AI Project Intelligence untuk Profesional Konstruksi",
    heroTitle: "AI Project Intelligence untuk Manajemen Proyek Konstruksi",
    heroSubtitle: "Pusatkan data proyek di Project Brain, jalankan Mini Apps AI untuk analisis otomatis, dan deploy agen cerdas untuk tim proyek Anda. Tanpa coding.",
    icon: Settings,
    color: "text-orange-500",
    painPoints: [
      { icon: Clock, problem: "Laporan proyek manual memakan waktu berjam-jam", solution: "Generate laporan otomatis dengan AI dari data Project Brain dalam hitungan menit" },
      { icon: AlertTriangle, problem: "Isu proyek sering terlewat dan terlambat di-follow up", solution: "Issue Log & Action Tracker otomatis mendeteksi, prioritaskan, dan eskalasi isu" },
      { icon: TrendingUp, problem: "Risiko proyek tidak teridentifikasi sejak dini", solution: "Risk Radar AI menganalisis risiko teknis, jadwal, dan biaya secara real-time" },
      { icon: Users, problem: "Informasi proyek tersebar dan sulit diakses tim", solution: "Project Brain memusatkan semua data proyek untuk akses tim kapan saja" },
    ],
    useCases: [
      { title: "Laporan Mingguan Otomatis", description: "Generate laporan progress proyek dari data Project Brain secara otomatis" },
      { title: "Risk Assessment Real-time", description: "AI menganalisis risiko teknis, jadwal, dan biaya proyek secara berkala" },
      { title: "QA/QC Checklist Digital", description: "Checklist inspeksi dan quality control dengan tracking digital" },
      { title: "Koordinasi Tim Lapangan", description: "Chatbot WhatsApp untuk komunikasi real-time dengan tim di lapangan" },
    ],
    testimonials: [
    ...
    faq: [
      { question: "Apakah cocok untuk proyek konstruksi?", answer: "Sangat cocok! Gustafta dilengkapi template khusus untuk civil engineering dan konstruksi - termasuk field untuk tahap proyek, jenis isu teknis, level risiko, dan batasan biaya/waktu." },
      { question: "Bisa diakses dari lapangan?", answer: "Ya, Gustafta bisa diakses via WhatsApp, web browser, atau widget chat dari mana saja termasuk di lokasi proyek." },
    ...
    stats: [
      ...
      { value: "70%", label: "Waktu Laporan Lebih Cepat" },
