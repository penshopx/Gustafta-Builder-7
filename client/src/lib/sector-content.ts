...
export const sectorContentMap: Record<string, SectorContent> = {
  engineering: {
    ...
    heroTitle: "19 Ekosistem & 250+ Chatbot Spesialis untuk Industri Jasa Konstruksi",
    ...
    useCases: [
      ...
      { title: "Project Brain & Mini Apps", description: "Pusatkan data proyek + 12 Mini Apps (laporan, checklist, risk radar) untuk tim internal" },
    ],
    testimonials: [
    ...
    stats: [
      ...
      { value: "250+", label: "Chatbot Spesialis" },
      { value: "46+", label: "Toolbox Konstruksi" },
