...
The platform employs a 5-level modular hierarchical structure (Series → Core → Big Idea/Orkestrator → Toolbox → Agent) for Jasa Konstruksi compliance across **20 series** (15 original + 5 baru di Apr 2026) totaling **~260 chatbot agents**, organized into 6 categories:
...
20. **Program Kompetensi Manajerial BUJK — ASPEKINDO** (12 chatbots, slug `kompetensi-manajerial-bujk`) — Program revitalisasi peran ASPEKINDO untuk meningkatkan kompetensi Personil Manajerial BUJK. Metodologi A-L-P-E-L (Awareness → Learning → Practice → Evaluation → Launch), scoring engine 4 domain (Kognitif 25%/Praktikal 35%/Kolaborasi 25%/Inovasi 15%), tier FREE/PRO/CORPORATE. 4 Rumpun Kurikulum: (1) Admin & Legal BUJK — legalitas dasar BUJK + dokumen kualifikasi tender Anti-Gugur Perpres 46/2025; (2) LKUT — Laporan Keuangan Usaha Tahunan sesuai SK Dirjen BK 37/2025; (3) SBU & Kualifikasi — lifecycle sertifikasi, upgrade kualifikasi, optimasi subklasifikasi; (4) SMAP & Anti-Penyuapan — ISO 37001, FKAP, compliance integritas. + Toolkit Manajerial BUJK (Generator LKUT, Checklist SBU, Risk Register, BoQ Builder, K3 Daily Report, KCI Dashboard). Seed: `server/seed-kompetensi-manajerial-bujk.ts`.
