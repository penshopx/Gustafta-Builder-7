...
The platform employs a 5-level modular hierarchical structure (Series → Core → Big Idea/Orkestrator → Toolbox → Agent) for Jasa Konstruksi compliance across **22 series** (15 original + 7 baru di Apr 2026) totaling **~274 chatbot agents**, organized into 6 categories:
