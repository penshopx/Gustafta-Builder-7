...
The platform employs a 5-level modular hierarchical structure (Series → Core → Big Idea/Orkestrator → Toolbox → Agent) for Jasa Konstruksi compliance across **23 series** (15 original + 8 baru di Apr 2026) totaling **~291 chatbot agents**, organized into 6 categories:
...
23. **Ringkasan Regulasi Konstruksi Indonesia 2025** (21 chatbots, slug `ringkasan-regulasi-konstruksi-2025`) — Ekosistem komprehensif berdasarkan Notion "Regulasi Jasa Konstruksi Indonesia — Ringkasan Lengkap" (19 bab). 1 Hub Utama + 8 BigIdeas: (1) Payung Hukum & Perizinan BUJK — Payung Hukum Navigator (UU 2/2017, PP 22/2020, PP 28/2025, Permen PU 6/2025) + BUJK Perizinan & OSS Advisor (NIB, PB-UMKU, SBU, PBBR); (2) Sertifikasi Badan Usaha & Profesi — LSBU & SBU Advisor + LSP & SKK Advisor + ASKOM/RCC & Kompetensi Asesor Advisor (SK BNSP 1511_VII_2025); (3) Pengadaan Konstruksi & Kontrak Kerja — Pengadaan PBJP Advisor (Perpres 46/2025) + Kontrak Kerja Konstruksi Advisor (klausa wajib Pasal 47, jaminan); (4) Keselamatan, Mutu & Pembinaan — SMKK & K3 Advisor (Permen PUPR 10/2021) + Manajemen Mutu & RMPK Advisor + Konstruksi Berkelanjutan & Green Building Advisor (BGH); (5) Integritas, Pengawasan & Sanksi — Konstruksi Berintegritas & Anti-Korupsi Advisor (SMAP, PANCEK KPK 2025) + Pengawasan Jasa Konstruksi Advisor (3 tertib) + Sanksi & Penyelesaian Sengketa Advisor (BANI, BADAPSKI, DSK); (6) Tenaga Kerja, Asosiasi & Digitalisasi — Tenaga Kerja Konstruksi & PKB Advisor + Asosiasi/LPJK & Akreditasi Advisor (ABU/AP/ARP) + SIJK/Digitalisasi & BUJK Asing Advisor (BUJK PMA, KPBUJKA); (7) Asesor Badan Usaha (ABU) & Sertifikasi BUJK Lanjutan — ABU & Penilaian Kesesuaian BUJK Advisor (SKKNI Kepmenaker 273/2024, 6 unit kompetensi, SMM LSBU ISO 17065, imparsialitas, KAN-LPJK-LSBU-ABU) + Ruang Lingkup & Subklasifikasi SBU Advisor (BG, BS, IN, KK, KP, PB, PA, PL dengan KBLI per subklas); (8) ASKOM Konstruksi & Uji Kompetensi SKK — ASKOM Konstruksi & Metodologi Asesmen Advisor (SKKNI 333/2020, MAPA/MA/MKVA, prinsip VRFA, alur SKK Permen PUPR 8/2022) + MUK Versi 2023 & RCC ASKOM Advisor (form FR.APL/FR.MAPA/FR.IA/FR.AK/FR.VA, kategori RCC A/B, penyelenggara). Seed: `server/seed-regulasi-jasa-konstruksi.ts`, color: #15803d, sortOrder: 20, threshold re-seed: >= 20.
