...
- **Federation Layer (66 hubs)**: 66 hub orchestrators with `agenticSubAgents` configured — parallel multi-agent synthesis. Includes: Tender, SKK, SBU, Perizinan, ASKOM, CSMS, SMAP, PANCEK, Odoo, AJJ, KAN, Lisensi LSP, IT LSP, ISO 14001/9001, PJBU, Kontraktor/Konsultan, Perizinan & Legalitas, Sertifikasi, Admin BUJK, Competency Mentoring, Problem Solver, Skema Navigator, LKUT, 9 Discipline Hubs (Sipil, Arsitektur, Energi, Sains, Mekanikal, Manajemen Pelaksanaan, Pengembangan Wilayah, Arsitek Lanskap, Tata Lingkungan), Hub Kompetensi Teknis, Manajemen Kontrak Hub, Legal Konstruksi Hub, RG Orchestrator (SKKNI 106), 6 SKKNI Jabatan (PKBG-ARS/MPBG/PKFS/PBH/MPK/MK-CM), LEX-ORCHESTRATOR (17 legal specialists).
...
- **Test Tracker**: Dual-tab evaluation tool — Tender (35 sel, 5 bot × 7 test) + Federation (330 sel, 66 hub × 5 F-test). Route: `/test-tracker`.
