...
- **Mini Apps (31 types — COMPLETE)**: `rubric_scoring` (Review & Rubric Scoring, AI), `risk_register` (Risk Register Builder, AI), `work_mode_selector` (4 Work Modes selector, interactive), `mentoring_plan` (Mentoring Plan Generator, AI — 8-week personal plan with weekly milestones). All 4 registered in schema.ts, mini-apps-panel.tsx, mini-app-public.tsx, server/routes.ts.
